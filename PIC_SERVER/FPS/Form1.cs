    ...
    public partial class Form1 : Form
    {
        ...
        public void Auto_check_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (Auto_check.Checked )
            {
                ...
                //FileAccess.sSettings

                //FileAccess.sSettings.Replace("<AUTOEOD>ENABLE","<AUTOEOD>DISABLE");
        ...
        //string sConfig, EODStatus="",HOURS="",MINUTES="",INTERVAL="";
      /*  private void Config_AutoEOD()
        {
            ...
            EODStatus = sConfig.Substring(FileAccess.sConfig.IndexOf("<AUTOEOD>") + 9, (FileAccess.sConfig.IndexOf("</AUTOEOD>") - FileAccess.sConfig.IndexOf("<AUTOEOD>") - 9));
            HOURS = sConfig.Substring(FileAccess.sConfig.IndexOf("<HOURS>") + 7, (FileAccess.sConfig.IndexOf("</HOURS>") - FileAccess.sConfig.IndexOf("<HOURS>") - 7));
            MINUTES = sConfig.Substring(FileAccess.sConfig.IndexOf("<MINUTES>") + 9, (FileAccess.sConfig.IndexOf("</MINUTES>") - FileAccess.sConfig.IndexOf("<MINUTES>") - 9));
            INTERVAL = sConfig.Substring(FileAccess.sConfig.IndexOf("<INTERVAL>") + 10, (FileAccess.sConfig.IndexOf("</INTERVAL>") - FileAccess.sConfig.IndexOf("<INTERVAL>") - 10)) ;
