...
namespace FPS
{
    ...
    public class PUMP
    {
        ...
        public void AuthorizationResponse(bool bPassACK)
        {
            ...
            //if (true)
            {
                ...
                sAuthorizedTime = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
        ...
        public static bool CancelSale(string sPassId, int iPassDeposit)
        {
            ...
            if (TRANs.Count > 0)
            {
                for (i = 0; i < TRANs.Count; i++)
                {
                    ...
                    if (TRANs[i].sTranId == sPassId)
                    {
                        TRANs[i].CancelSale(DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss"), iPassDeposit);
                    }
                }
                return true;
            }
    ...
    public class TRAN
    {
        ...
        public void SalesReport(string sPassGrade, string sPassVolume, string sPassBought, string sPassPrice)
        {
            ...
            this.sCompletedTime = dtCompleted.ToString("yyyy-MM-dd HH:mm:ss");// change formate
        ...
        public void CancelSale(string sPassTime, int iPassDeposit)
        {
            ...
            this.dtCompleted = DateTime.Now;
            this.sCompletedTime = dtCompleted.ToString("yyyy-MM-dd HH:mm:ss");
            this.sShowTime = dtCompleted.ToString();
    ...
    public static class DB
    {
       ...
       private static void Auto_GenerateEodReport(Object stateInfo)
        {
            ...
            try {
                ...
                if (IsGenerateEOD_report)
                {
                    ...
                    dtNow = DateTime.Now;
                    sReportTime = dtNow.ToString("yyyy-MM-dd HH:mm:ss");
                    sShowTimeEnd = dtNow.ToString("yyyy-MM-dd HH:mm:ss");

                    sFromTime = GetEodStartTime()[0];
                    sShowTimeStart = GetEodStartTime()[1];
                    Debug.WriteLine("sFromTime:" + sFromTime + " sShowTimeStart:" + sShowTimeStart);
                    SQL_SERVER.Set_Sql_Server_Conn();


                    sQuery = @"INSERT INTO TRANSACTIONS_REPORTS (REPORT_TIME, FROM_TIME, SHOW_TIME_START, SHOW_TIME_END) VALUES('" + sReportTime + "', '" + sFromTime + "', '" + sShowTimeStart + "', '" + sShowTimeEnd + "')";
     ...
     /*  private static void Auto_GeneratePIC_Cash_Report(Object stateInfo)
        ...
        {
            string sQuery = @"INSERT INTO tbl_TRANSACTIONS (TRAN_ID, PIC, PUMP, RESERVED_TIME) Values('" + sPassID + "', " + iPassPicNum + ", " + iPassPumpNum + ", '" + sPassTime + "')";
            Debug.WriteLine(sQuery); 
        ...
        {
            string sQuery = @"UPDATE tbl_TRANSACTIONS SET AUTHORIZED_TIME = '" + sPassTime + "', DEPOSIT = '" + sPassAmount + "' WHERE TRAN_ID LIKE '" + sPassID + "'";
            Debug.WriteLine(sQuery);
            SQL_SERVER.ExecuteNonQuery(sQuery);
        }
        ...
        {
            string sQuery = @"UPDATE tbl_TRANSACTIONS SET PURCHASE = " + sPassPurchased + ", PRICE = '" + sPassPrice + "', VOLUME = " + sPassVolume + ", GRADE = '" + sPassGrade + "', CHANGE = '" + sPassChange + "', COMPLETED_TIME = '" + sPassCompletedTime + "', SHOW_TIME = '" + sPassShowTime + "' WHERE TRAN_ID LIKE '" + sPassID + "'";
            Debug.WriteLine(sQuery);
            SQL_SERVER.ExecuteNonQuery(sQuery);
        }
        ...
        {
            string sQuery = @"UPDATE CASSETTES SET BILLS = BILLS + " + 1 + ", TOTAL = TOTAL + " + iPassBillValue + " WHERE PIC = " + iPassPicNum + " AND PULLED = 0";
            Debug.WriteLine(sQuery);
            SQL_SERVER.ExecuteNonQuery(sQuery);
        }
        ...
        {
            DateTime dtNow = DateTime.Now;
            string sQuery = @"UPDATE CASSETTES SET PULLED_TIME = '" + dtNow.ToString("yyyy-MM-dd HH:mm:ss") + "', SHOW_TIME = '" + dtNow.ToString() + "', PULLED = YES WHERE PIC = " + iPassPicNum + " AND PULLED = 0";
            Debug.WriteLine(sQuery);
            SQL_SERVER.ExecuteNonQuery(sQuery);
        ...
        public static void GetCassette(int iPassPicNum)
        {
            ...
            SQL_SERVER.Set_Sql_Server_Conn();
            SQL_SERVER.Open_Sql_Server_Conn();
            sQuery = "SELECT PIC FROM CASSETTES WHERE PIC = " + iPassPicNum + " AND PULLED = 0";
        ...
        public static void UpdateEodView()
        {
            try
            {
                ...
                sQuery = "SELECT REPORT_TIME, FROM_TIME, SHOW_TIME_START, SHOW_TIME_END FROM TRANSACTIONS_REPORTS ORDER BY REPORT_TIME DESC";
                SQL_SERVER.Open_Sql_Server_Conn();
                dbCmd = SQL_SERVER.Set_Sql_Server_Cmd(sQuery);
                // SQL_SERVER.Open_Sql_Server_Conn();
        ...
        public static void UpdateCompletedTransView()
        {
           ...
           /* OleDbCommand dbCmd;
            ...
            //sQuery = "SELECT COMPLETED_TIME, PIC, PUMP, DEPOSIT, PURCHASE, PRICE, CHANGE, GRADE, VOLUME, SHOW_TIME, TRAN_ID FROM tbl_TRANSACTIONS ORDER BY COMPLETED_TIME DESC";
            sQuery = "SELECT COMPLETED_TIME, PIC, PUMP, DEPOSIT, PURCHASE, PRICE, GRADE, VOLUME, SHOW_TIME, TRAN_ID,CHANGE FROM tbl_TRANSACTIONS ORDER BY COMPLETED_TIME DESC;";
            dbCmd = SQL_SERVER.Set_Sql_Server_Cmd(sQuery) ;
            drRecordSet = dbCmd.ExecuteReader();
           ...
           /* OleDbCommand dbCmd;
            ...
            if (Printer.iStatus == 1)
            {
                ...
                try
                {
                    ...
                    {
                        sQuery = @"SELECT SUM(VOLUME) AS VOLUME_TOTAL, SUM(PURCHASE) AS PURCHASE_TOTAL FROM tbl_TRANSACTIONS WHERE GRADE LIKE '" + iGrade + "' AND COMPLETED_TIME BETWEEN '" + sReportTime + "' AND '" + sFromTime + "'";
                    ...
                    sQuery = @"SELECT SUM(DEPOSIT) AS DEPOSIT_TOTAL, SUM(CHANGE) AS CHANGE_TOTAL FROM tbl_TRANSACTIONS WHERE COMPLETED_TIME BETWEEN '" + sReportTime + "' AND '" + sFromTime + "'";
           ...
           /* OleDbCommand dbCmd;
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        myCashStruct.sFromTime = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                        myCashStruct.sShowTimeStart = DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss");
                    }
                    //dbCmd.Dispose();
                    //drRecordSet.Dispose();
                }
        ...
        static string[] GetEodStartTime()
        {
            string sQuery;
            string sFromTime="";
            string sShowTimeStar="";
            SqlCommand dbCmd;
            //OleDbDataReader drRecordSet;
            SqlDataReader drRecordSet;
            SQL_SERVER.Set_Sql_Server_Conn();
            ...
            try
            {
                sQuery = "SELECT REPORT_TIME, SHOW_TIME_END FROM TRANSACTIONS_REPORTS ORDER BY REPORT_TIME DESC";
                dbCmd = SQL_SERVER.Set_Sql_Server_Cmd(sQuery);
                drRecordSet = dbCmd.ExecuteReader();
                ...
                if(drRecordSet.HasRows)
                {
                   ...
                   /* sFromTime = drRecordSet["REPORT_TIME"].ToString();
                   string[] dateSplit = drRecordSet["SHOW_TIME_END"].ToString().Split(' ');
                    string[] Date = dateSplit[0].Split('-');
                    string Time = dateSplit[1];*/

                   // sShowTimeStar = Date[2] + "-" + Date[1] + "-" + Date[0]+" "+Time; 
                    DateTime dt = Convert.ToDateTime(drRecordSet.GetValue(1).ToString());
                    sShowTimeStar = dt.ToString("yyyy-MM-dd HH:mm:ss");
                    DateTime dt1 = Convert.ToDateTime(drRecordSet.GetValue(0).ToString());
                    sFromTime = dt1.ToString("yyyy-MM-dd HH:mm:ss");



                    Debug.WriteLine("REPORT_TIME :" + drRecordSet["REPORT_TIME"] + " SHOW_TIME_END:" + drRecordSet["SHOW_TIME_END"]);
                }
                else
                {
                    ...
                    sQuery = "SELECT COMPLETED_TIME, SHOW_TIME FROM tbl_TRANSACTIONS ORDER BY COMPLETED_TIME";
                    dbCmd = SQL_SERVER.Set_Sql_Server_Cmd(sQuery);
                    drRecordSet = dbCmd.ExecuteReader();
                    ...
                    sFromTime = drRecordSet.GetString(0);
                    sShowTimeStar = drRecordSet.GetString(1);
                }
                Debug.WriteLine(drRecordSet[0].ToString());
                //sFromTime = drRecordSet.GetString(0);
                //sShowTimeStar = drRecordSet.GetString(1);
            ...
            catch (Exception ex)
            {
               ...
               //ErrorLogEvents(ex.ToString());
                ...
                Debug.WriteLine("generate EOD error: " + ex);
            }
          ...
          // myEodStruct.sReportTime = "";
            ...
            return new string[2] { sFromTime, sShowTimeStar };
        }
...
public class SQL_SERVER
{
    ...
    public static SqlDataReader dbr;


    public static void Set_Sql_Server_Conn()
    {

        string server_string = "Data Source=LAPTOP-EMJVR3G8;Initial Catalog=master;Integrated Security=True;";
        sql_con = new SqlConnection(server_string);
    }
    ...
    public static SqlCommand Set_Sql_Server_Cmd(string Cmd_str)
    {

        return new SqlCommand(Cmd_str, sql_con);
    }
    ...
    public static void ExecuteNonQuery(string sPassQuery)
    {
        try
        {
            SqlCommand cmd = new SqlCommand(sPassQuery, sql_con);
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.ExecuteNonQuery();
            cmd.Dispose();
        }
    ...
    internal static SqlConnection Return_Conn()
    {
        string server_string = "Data Source=DESKTOP-MGVG5O7\\SQLEXPRESS;Initial Catalog=master;Integrated Security=True;";
        sql_con = new SqlConnection(server_string);
        return sql_con;
    }
}